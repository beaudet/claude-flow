...
exports.createCompatDirname = createCompatDirname;
const url_1 = require("url");
const path_1 = require("path");
/**
 * Get current file path in both ESM and CJS environments
 */
function getCurrentFilePath(importMetaUrl) {
 ...
 */
function getCurrentDirPath(importMetaUrl) {
    return (0, path_1.dirname)(getCurrentFilePath(importMetaUrl));
}
/**
 * Get project root path relative to current file
 */
function getProjectRoot(importMetaUrl) {
    ...
    return (0, path_1.resolve)(getCurrentDirPath(importMetaUrl), '../..');
}
/**
 ...
 */
function createCompatDirname(importMetaUrl) {
    ...
    return {
        __filename: filename,
        __dirname: (0, path_1.dirname)(filename),
    };
}
